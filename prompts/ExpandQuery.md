...
- country: ISO code (e.g. "US","IN","GB"). null if not stated -- never default to any specific country
- remote_preference: "remote_only" | "hybrid_ok" | "in_office_only" | "open" (default if unstated: "open"). Set a non-"open" value ONLY when the message itself contains remote/hybrid/onsite/WFH language. "worldwide"/"anywhere"/"global" are LOCATION words, NOT remote signals -- they alone never justify "remote_only".
