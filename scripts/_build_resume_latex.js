// ═══════════════════════════════════════════════════════════════
// Build Resume LaTeX — JSON → LaTeX with production-tested helpers
// Ported verbatim from Career_Forge_Web/server/resumeforge.ts + latex.ts
// ═══════════════════════════════════════════════════════════════

// ─── Helper: escapeLatexText (resumeforge.ts:15-27) ───
...
// ─── Helper: extractBetweenMarkers (resumeforge.ts:29-45) ───
...
// ─── Helper: wrapResumeWithSkeleton (resumeforge.ts:47-87) ───
...
// ─── Helper: sanitizeResumeContentBlock (resumeforge.ts:89-211) ───
...
// ─── Helper: normalizeLatexForPdflatex (latex.ts:125-153) ───
...
// ─── Main: Convert ResumeForge JSON → LaTeX ───
const resumeJson = $input.first().json.output || $input.first().json;
const ctx = $('Prepare Apply Context').item.json;
const skeleton = ctx.resume_skeleton;
const personal = ctx.personal || {};

// Build header LaTeX by replacing skeleton header placeholders
...
// Convert JSON sections to LaTeX
