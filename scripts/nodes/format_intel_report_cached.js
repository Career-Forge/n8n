...
const sections = [
  ...
  '\u{1F4CA} *Sentiment:* ' + (r.sentiment && r.sentiment.overall_mood || 'Unknown') + (r.sentiment && r.sentiment.glassdoor_rating ? ' (' + (r.sentiment.review_source || 'Reviews') + ': ' + r.sentiment.glassdoor_rating + ')' : ''),
];
...
sections.push('\u{1F6C2} *Visa Sponsorship:* ' + (r.visa_sponsorship && r.visa_sponsorship.sponsors ? 'Yes' : 'Unknown'));
sections.push('');
