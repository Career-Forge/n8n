...
for (const item of hits) {
  ...
  for (const r of results) {
    ...
    allJobs.push({
      ...
      updated_at: parsePostedDate(r.metadata?.publishedTime || r.publishedTime || ''),
      source: 'firecrawl',
