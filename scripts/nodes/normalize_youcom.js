...
for (const item of hits) {
  ...
  for (const r of entries) {
    ...
    allJobs.push({
      ...
      updated_at: parsePostedDate(r.page_age || r.published_date || ''),
      source: 'youcom',
